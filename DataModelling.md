...
* **Relationships**
    ...
    * ‘Inlined’ objects
* **Enums. **This is used to constrain the number of possible values a property might have. Enum is a lightweight object like an inline object, which typically has a string, and ID, and sometimes one extra property. Country is a special type of enum and is an aberration. We don’t create things like this. Instead we create a model, like Asset and a value of a property then is a reference to that object.
